...
from monai.transforms import (
    AsDiscreted, Compose, CropForegroundd, EnsureChannelFirstd, EnsureTyped,
    LoadImaged, MapLabelValued, NormalizeIntensityd, Orientationd,
    RandFlipd, RandScaleIntensityd, RandShiftIntensityd,
    RandSpatialCropSamplesd, SpatialPadd,
)
...
def get_train_transforms(patch_size: tuple[int, int, int], samples_per_volume: int):
    return Compose([
        ...
        RandSpatialCropSamplesd(keys=["image", "mask"], roi_size=patch_size, num_samples=samples_per_volume, random_center=True, random_size=False),
