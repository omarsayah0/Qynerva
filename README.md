...
========================================================================
  ...
  • The high overall accuracy is mainly driven by the dominance of the 
    background class. Tumor region performance—especially recall—
    remains relatively low. This limitation is acknowledged and is 
    currently being addressed.

  • F1/Dice per class is computed as voxel-wise Dice:
    (2TP / (2TP + FP + FN)).

  • Tumor classes:
    NCR = Necrotic Core, ED = Edema, ET = Enhancing Tumor.
========================================================================
```
